...
export const projects = [
  {
    id: 1,
    name: "Personalised Retrieval-Augmented Chatbot System",
    description: "Context-aware chatbot with persistent user memory using Gemini API and MongoDB. Implements retrieval pipelines for relevant, personalized responses and supports real-time interaction via Gradio.",
  ...
  {
    id: 2,
    name: "EduTrack – Location-Aware Attendance System",
    description: "Secure attendance system using geolocation constraints and liveness verification to prevent proxy marking. Includes backend workflows for validation, logging, and real-time tracking.",
  ...
  {
    id: 3,
    name: "Email Rewriting API with Transformer-Based Inference",
    description: "Flask-based REST API for real-time email rewriting using a fine-tuned transformer model. Includes scalable inference pipeline and reproducible training workflow.",
    tech: ["Python", "Flask", "Transformers", "Hugging Face", "NLP"],
    live: "#",
    github: "#",
    category: "ML",
    featured: true,
  ...
  {
    id: 4,
    name: "Meal Minder – Food Waste Reduction System (SIH)",
    description: "Reward and penalty-based system to reduce food wastage in hostels/mess. Tracks consumption patterns and applies incentives or penalties to influence user behavior.",
